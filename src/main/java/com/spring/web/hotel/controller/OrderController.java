...
import com.spring.web.hotel.model.Status;
import com.spring.web.hotel.repository.OrderRepository;
...
public class OrderController {
    ...
    ResponseEntity<?> cancel(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                ...
                .body(Problem.create().withTitle("Method not allowed").withDetail("You can not cancel an order that is in the " + order.getStatus() + " status"));
    }
}
